defmodule Infusionsoft.Endpoints.XML.File do
  ...
  def upload_a_file(id, file_name, base_64_encoded_data, token, app \\ nil) do
  ...
  def retrieve_a_file(id, token, app \\ nil) do
  ...
  @spec replace_a_file(integer(), String.t(), String.t(), nil | String.t()) ::
          {:ok, integer()} | {:error, String.t()}
  def replace_a_file(id, base_64_encoded_data, token, app \\ nil) do
  ...
  @spec rename_a_file(integer(), String.t(), String.t(), nil | String.t()) ::
          {:ok, integer()} | {:error, String.t()}
  def rename_a_file(id, name, token, app \\ nil) do
